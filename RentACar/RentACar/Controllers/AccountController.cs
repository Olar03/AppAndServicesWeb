    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register()
        {
            AddUserViewModel model = new()
            {
                ...
                Licences = await _combosHelper.GetComboLicencesAsync(),
        ...
        public async Task<IActionResult> Register(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    model.Licences = await _combosHelper.GetComboLicencesAsync();
                    return View(model);
                }
        ...
        //CHANGE PASSWORD---CAMBIO DE COMTRASEÑA
        ...
        public async Task<IActionResult> ChangeUser(EditUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                user.Licence = await _context.Licences.FindAsync(model.LicenceId);
